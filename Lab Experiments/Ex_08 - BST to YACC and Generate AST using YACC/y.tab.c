...
#line 52 "ast_parser.y"
                      { (yyval.ptr) = createOpNode('+', (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1157 "y.tab.c"
    break;

  case 4: /* expr: expr '-' expr  */
#line 53 "ast_parser.y"
                      { (yyval.ptr) = createOpNode('-', (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1163 "y.tab.c"
    break;

  case 5: /* expr: expr '*' expr  */
#line 54 "ast_parser.y"
                      { (yyval.ptr) = createOpNode('*', (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1169 "y.tab.c"
    break;

  case 6: /* expr: expr '/' expr  */
#line 55 "ast_parser.y"
                      { (yyval.ptr) = createOpNode('/', (yyvsp[-2].ptr), (yyvsp[0].ptr)); }
#line 1175 "y.tab.c"
    break;

  case 7: /* expr: '(' expr ')'  */
#line 56 "ast_parser.y"
                      { (yyval.ptr) = (yyvsp[-1].ptr); }
#line 1181 "y.tab.c"
    break;

  case 8: /* expr: NUMBER  */
#line 57 "ast_parser.y"
                      { (yyval.ptr) = createNumNode((yyvsp[0].num)); }
#line 1187 "y.tab.c"
    break;
